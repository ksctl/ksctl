...
func (obj *CivoProvider) NewVM(state resources.StateManagementInfrastructure) error {
	fmt.Printf("[civo] creating %s VM...\n", obj.Metadata.ResName)
	return nil
}

// DelVM implements resources.CloudInfrastructure.
func (obj *CivoProvider) DelVM(state resources.StateManagementInfrastructure) error {
