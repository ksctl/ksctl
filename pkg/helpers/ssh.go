...
func (sshPayload *SSHPayload) SSHExecute(log resources.LoggerFactory) error {
	...
	// TODO: need to find best solution -> https://groups.google.com/g/golang-nuts/c/b217QeNZtbA
	// FIXME: https://pkg.go.dev/golang.org/x/crypto/ssh#Session.Run
	// WARN: For now moving with newSession() each command to create
