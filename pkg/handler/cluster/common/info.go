...
func (kc *Controller) clusterDataHelper(operation logger.LogClusterDetail) (_ []provider.ClusterData, errC error) {
	...
	case consts.CloudAzure:
		cloudMapper[consts.CloudAzure], err = azure.NewClient(kc.ctx, kc.l, kc.b.KsctlWorkloadConf.WorkerCtx, kc.p.Metadata, nil, kc.p.Storage, azure.ProvideClient)

	case consts.CloudAws:
		cloudMapper[consts.CloudAws], err = aws.NewClient(kc.ctx, kc.l, kc.b.KsctlWorkloadConf.WorkerCtx, kc.p.Metadata, nil, kc.p.Storage, aws.ProvideClient)

	case consts.CloudLocal:
		cloudMapper[consts.CloudLocal], err = local.NewClient(kc.ctx, kc.l, kc.b.KsctlWorkloadConf.WorkerCtx, kc.p.Metadata, nil, kc.p.Storage, local.ProvideClient)
