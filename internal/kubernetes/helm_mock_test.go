...
func (h helmClientMock) InstallChart(chartVer string, chartName string, namespace string, releaseName string, createNamespace bool, arguments map[string]interface{}) error {
	return nil
}
