...
func TestMain(m *testing.M) {
	...
	demoClient.Cloud, _ = ReturnLocalStruct(demoClient.Metadata, ProvideMockClient)
...
func TestManagedCluster(t *testing.T) {
	...
	assert.Equal(t, testClient.InitState(demoClient.Storage, consts.OperationStateCreate), nil, "Init must work before")
